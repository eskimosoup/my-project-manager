...
RSpec.describe InvoiceSearch, type: :model do
  it 'searching paid invoices' do
    ...
    invoice1 = create(:percentage_invoice, project: project, paid: true)
    invoice2 = create(:percentage_invoice, project: project, paid: false)
  ...
  it 'searching unpaid invoices' do
    project = create(:project)
    invoice1 = create(:percentage_invoice, project: project, paid: false)
    invoice2 = create(:percentage_invoice, project: project, paid: true)
  ...
  it 'search by customer' do
    ...
    invoice = create(:percentage_invoice, project: project)
    customer2 = create(:customer)
    project2 = create(:project, customer: customer2)
    invoice2 = create(:percentage_invoice, project: project2)
