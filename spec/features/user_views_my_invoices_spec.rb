...
feature "user views my invoices" do
  scenario "all invoices" do
    ...
    invoice = create(:percentage_invoice, project: project, name: "My invoice") 
  ...
  scenario "paid invoices" do
    user = create(:user)
    project = create(:project)
    paid_invoice = create(:percentage_invoice, paid: true, project: project, name: "Invoice A") 
    unpaid_invoice = create(:percentage_invoice, paid: false, project: project, name: "Invoice B") 
