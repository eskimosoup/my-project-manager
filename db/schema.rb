...
ActiveRecord::Schema.define(version: 20170523141259) do
  ...
  create_table "envisage_invoices", force: :cascade do |t|
  ...
  add_index "envisage_invoices", ["project_id"], name: "index_envisage_invoices_on_project_id", using: :btree
  ...
  create_table "invoices", force: :cascade do |t|
    ...
    t.string   "type",                                               default: "PercentageInvoice"
    t.text     "vat_items_description"
    t.decimal  "vat_items_total",           precision: 10, scale: 2
    t.text     "non_vat_items_description"
    t.decimal  "non_vat_items_total",       precision: 10, scale: 2
  end
  ...
  add_foreign_key "envisage_invoices", "projects"
